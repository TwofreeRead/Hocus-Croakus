Shader "AllIn13DShader - Baked Effects/StoredMana"
{
	Properties
	{
...
#define _SHADINGMODEL_BASIC
#define _HIGHLIGHTS_ON
#define _RIM_LIGHTING_ON
#define _RIMLIGHTINGSTAGE_BEFORELIGHTING
#define _EMISSION_ON
#define _MATCAP_ON
#define _MATCAPBLENDMODE_MULTIPLY
#define _ALBEDO_VERTEX_COLOR_ON
#define _ALBEDOVERTEXCOLORMODE_REPLACE
#define _SCROLL_TEXTURE_ON
